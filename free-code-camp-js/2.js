...
*/
/* class 69 COMPARACIONES CON EL OPERADOR LÓGICO Y

a veces necesitaremos probar más de una vosa a la vez. el operador 
lógico and && devuelve true si y solo si los operados a la izquierda
y a la derecha son verdaderos.
se podría lograr el mismo efecto anidando una sentencia if dentro
de otra if:
...
solo regresará yes si num es mayor que 5 y menor que 10.
la misma lógica se puede esrcibir como:
